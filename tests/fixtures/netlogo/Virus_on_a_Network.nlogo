...
<experiments>
  <experiment name="oracle_sir_network_GT" repetitions="30" runMetricsEveryStep="true">
    ...
    <enumeratedValueSet variable="number-of-nodes"><value value="150"/></enumeratedValueSet>
    <enumeratedValueSet variable="average-node-degree"><value value="6"/></enumeratedValueSet>
    <enumeratedValueSet variable="initial-outbreak-size"><value value="3"/></enumeratedValueSet>
    <enumeratedValueSet variable="virus-check-frequency"><value value="1"/></enumeratedValueSet>
    <enumeratedValueSet variable="virus-spread-chance"><value value="4.4"/></enumeratedValueSet>
    <enumeratedValueSet variable="recovery-chance"><value value="2.5"/></enumeratedValueSet>
    <enumeratedValueSet variable="gain-resistance-chance"><value value="25"/></enumeratedValueSet>
  </experiment>
  <experiment name="oracle_network_topology" repetitions="30" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="0"/>
    <metric>count links</metric>
    <metric>mean [count link-neighbors] of turtles</metric>
    <metric>max [count link-neighbors] of turtles</metric>
    <metric>min [count link-neighbors] of turtles</metric>
    <metric>standard-deviation [count link-neighbors] of turtles</metric>
    <enumeratedValueSet variable="number-of-nodes"><value value="150"/></enumeratedValueSet>
    <enumeratedValueSet variable="average-node-degree"><value value="6"/></enumeratedValueSet>
    <enumeratedValueSet variable="initial-outbreak-size"><value value="3"/></enumeratedValueSet>
    <enumeratedValueSet variable="virus-check-frequency"><value value="1"/></enumeratedValueSet>
