...
**Date**: 2026-05-31 08:44  
**Story**: `examples/calibration_challenge_virus/story.md`  
**Mode**: reproduce (no --external-model — full codegen path)  
**Iterations**: 2  
**Workspace**: `/home/user/Documents/Social Simulation /mymomo-academic/workspace/dogfood_codegen_1780187893`

## TL;DR

- Exit code: **0**
- Wall time: **351s** (5.9 min)
...
|---|---|---|---|
| `virus_spread_chance` | 4.4 | 15.210 | 245.7% |
| `recovery_chance` | 2.5 | 3.686 | 47.4% |
| `gain_resistance_chance` | 25.0 | 47.861 | 91.4% |
...
| Report generated? | True (3,706 chars) |
| ARS package? | True |
