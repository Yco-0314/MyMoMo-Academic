...
Three scripts for measuring the calibration pipeline against the virus-on-a-network
calibration challenge ground truth (`virus_spread_chance=4.4`, `recovery_chance=0.3`,
